...
public class kafkaConsumerConfigurations {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Administrator> jsonKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, Administrator> factory = new ConcurrentKafkaListenerContainerFactory<>();
    ...
    public DefaultKafkaConsumerFactory jsonConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(
                ...
                new JsonDeserializer<>(Administrator.class));
    }
